    ...
    <main className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <section id="services" className="py-32 px-6 bg-black">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-5xl font-black mb-16">Tjänster</h2>
      ...
      <section id="contact" className="py-32 px-6 bg-zinc-950">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-black mb-6">Kontakt</h2>
          ...
          <div className="grid md:grid-cols-2 gap-10">
            <div className="bg-zinc-900 rounded-3xl p-10 border border-white/10">
              <h3 className="text-3xl font-black mb-8">Kontaktinformation</h3>

              <div className="space-y-6 text-zinc-400">
                <div>
                  <p className="text-white font-semibold mb-1">E-post</p>
                  <p>Velora.media.stockholm@gmail.com</p>
                </div>
